...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="flex items-center justify-center relative p-2 md:pt-20"
      ref={containerRef}
    >
      <div
...
export const Header = ({ translate, titleComponent }: { translate: number, titleComponent: ReactNode}) => {
  return (
    <motion.div
      style={{
